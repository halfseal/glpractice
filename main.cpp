...
void ReadVerticesFromFile(const std::string &filename, std::vector<float> &vertices);
...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("shader/main_vert.glsl", "shader/main_frag.glsl");

    std::vector<float> verticesVector;
    ReadVerticesFromFile("pointcloud1.txt", verticesVector);

    float vertices[verticesVector.size()];
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindVertexArray(VAO);
        glPointSize(1.0f);
        glDrawArrays(GL_POINTS, 0, static_cast<int>(sizeof(vertices) / sizeof(float) / 3));
